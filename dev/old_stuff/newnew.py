...
train_data['miles_per_month'] = train_data['avg_dist'] * \
    train_data['trips_in_first_30_days']
...
rfc_model = RandomForestClassifier(n_estimators=10000,
                                   max_depth=5)
...
y_test = y[test_idx]
    ...
    print(f'logistic reg. coef_: {lr_model.coef_}')
...
pred_v_accu = y_pred - y_test
pd.DataFrame(pred_v_accu)
